...
//            }
        ...
        {
//            skiplist_.Find1(key);
//            printf("key=%s,find_key=%s\n",key.start_key,skiplist_.head_->next[0]->keyvalue.first.start_key);
//            int64_t* a = (int64_t*)(key.start_key);
//            int64_t* b = (int64_t*)(skiplist_.head_->next[3]->keyvalue.first.start_key);
//            if(key<skiplist_.head_->next[3]->keyvalue.first)
//            {
//                printf("not normal!\n");
//            }
//            if(*a<*b)
...
//    }
//    printf("1\n");
    if (status == skiplist_.Scan(start_key, end_key, nodes))
        return status;
//    printf("2\n");
    for(int i=0; i<(int)(nodes.size()); i++)
    {
//        printf("3\n");
        if(i>10 || i>SCAN_LENGTH)
        {
            break;
        }
...
//            printf("block_list[i].address:%lu\n",block_list[i].address);
